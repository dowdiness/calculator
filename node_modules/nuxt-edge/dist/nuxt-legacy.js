...
function () {
  ...
  _createClass(ModuleContainer, [{
    ...
    value: function addLayout(template, name) {
      ...
      this.options.layouts[name || path__default.parse(src).name] = "./".concat(dst);
    }
  }, {
...
var keywords = ["nuxt", "nuxt.js", "nuxtjs", "vue", "vue.js", "vuejs", "vue universal", "vue ssr", "vue server side", "ssr", "vue isomorphic", "vue versatile"];
  ...
  _createClass(Nuxt, [{
    ...
    value: function listen() {
      ...
      return this.ready().then(function () {
        return new Promise(function (resolve, reject) {
          var server = _this3.renderer.app.listen({
            port: port,
            host: host,
            exclusive: false
          }, function (err) {
            ...
            var listenURL = Chalk.underline.blue("http://".concat(host, ":").concat(port));
            _this3.readyMessage = "Listening on ".concat(listenURL); // Close server on nuxt close
...
function () {
  ...
  _createClass(WebpackBaseConfig, [{
    ...
    key: "customize",
    value: function customize(config) {
      if (typeof this.options.build.extend === 'function') {
        var extendedConfig = this.options.build.extend.call(this.builder, config, this.nuxtEnv); // Only overwrite config when something is returned for backwards compatibility
    ...
    value: function config() {
      ...
      var config = {
        ...
        plugins: this.plugins() // Clone deep avoid leaking config between Client and Server
...
function (_WebpackBaseConfig) {
  ...
  _createClass(WebpackClientConfig, [{
    ...
    value: function customize() {
      var config = _get(_getPrototypeOf(WebpackClientConfig.prototype), "customize", this).apply(this, arguments); // Make uglifyjs faster
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 7:
                ...
                if (!templateVars.components.ErrorPage && hasErrorLayout) {
                  templateVars.components.ErrorPage = this.relativeToBuild(this.options.srcDir, "".concat(this.options.dir.layouts, "/error.vue"));
                }
